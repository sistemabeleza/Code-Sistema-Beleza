...
import { Check, Calendar, DollarSign, Users, BarChart3, Package, FileText, CheckCircle, Clock, Shield, Award, Wrench } from 'lucide-react'
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-800">
                <Link
                  href="/admin/login"
                  className="inline-flex items-center space-x-3 px-5 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg shadow-lg transition-all hover:scale-105 font-medium"
                  title="Painel Administrativo"
                >
                  <Wrench className="w-5 h-5" />
                  <span>Painel Admin</span>
                </Link>
                <p className="text-xs text-gray-500 mt-2">Acesso restrito para desenvolvedores</p>
              </div>
            </div>
